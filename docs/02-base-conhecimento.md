...
| Arquivo | Formato | Finalidade Profin|
|---------|---------|---------------------|
| `historico_atendimento.csv` | CSV | Contextualizar interações anteriores |
| `perfil_investidor.json` | JSON | Personalizar explicações |
| `produtos_financeiros.json` | JSON | Mostrar e ensinar sobre os produtos |
...
O produto Fundo Imobiliario (FI) foi adicionado.
...
with open('data/perfil_investidor.json', 'r', encoding='utf-8') as arq:
    # Carrega os dados do arquivo para uma variável
...
[
  ...
  },
  {
  ...
  },
   {
    ...
    "aporte_minimo": 100.00,
    "indicado_para": "Perfil moderado que busca diversificação e renda mensal"
  },
  {
    "nome": "Fundo de Ações",
    "categoria": "fundo",
